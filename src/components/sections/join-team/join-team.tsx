...
export function JoinTeam() {
    ...
    const [investCardWidth, setInvestCardWidth] = useState("120%"); // Wider than container for more impact
    
    const benefits = [
        {
          icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 mb-6">
              <path d="M12 1V23" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M17 5H9.5C8.57174 5 7.6815 5.36875 7.02513 6.02513C6.36875 6.6815 6 7.57174 6 8.5C6 9.42826 6.36875 10.3185 7.02513 10.9749C7.6815 11.6313 8.57174 12 9.5 12H14.5C15.4283 12 16.3185 12.3687 16.9749 13.0251C17.6313 13.6815 18 14.5717 18 15.5C18 16.4283 17.6313 17.3185 16.9749 17.9749C16.3185 18.6313 15.4283 19 14.5 19H6" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ),
        ...
        },
        {
          icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 mb-6">
              <path d="M21 5H3C1.89543 5 1 5.89543 1 7V19C1 20.1046 1.89543 21 3 21H21C22.1046 21 23 20.1046 23 19V7C23 5.89543 22.1046 5 21 5Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M5 5V3C5 1.89543 5.89543 1 7 1H17C18.1046 1 19 1.89543 19 3V5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M10 12H14" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M12 10V14" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ),
          title: "401(k) plan"
        },
        {
          icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 mb-6">
              <path d="M11 3H3V11H11V3Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M21 3H13V11H21V3Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M21 13H13V21H21V13Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M11 13H3V21H11V13Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ),
        ...
        },
        {
          icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 mb-6">
              <path d="M20 3H4C2.89543 3 2 3.89543 2 5V15C2 16.1046 2.89543 17 4 17H20C21.1046 17 22 16.1046 22 15V5C22 3.89543 21.1046 3 20 3Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M8 21H16" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M12 17V21" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M7 10H17" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M9 7H15" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M7 13H17" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ),
        ...
        },
        {
          icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 mb-6">
              <path d="M20 4L18 12H16L14 4" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M17 12V20" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M7 4V20" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M7 4C7 4 4 5 4 8C4 11 7 12 7 12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ),
    ...
    return (
        <section id="join-team" className="w-full py-40 relative overflow-hidden bg-black/70 z-10">
            {/* Content */}
            <div className="container max-w-6xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    <FadeInSection>
                        <h2 className="text-6xl font-medium mb-8 text-white">
                            Join Our Team
                        </h2>
                    </FadeInSection>
                </div>
                        ...
                        {benefits.map((benefit, index) => (
                            <FadeInSection key={index} delay={index * 50}>
                                <div className="group h-full rounded-2xl border border-gray-800 hover:border-gray-700 transition-all duration-500 hover:translate-y-[-4px] backdrop-blur-sm bg-black/40 overflow-hidden">
                                    <div className="p-6">
                                        {benefit.icon}
                                        <h3 className="text-xl font-medium text-white group-hover:text-[#B3EBF2] transition-colors duration-300">
                                            {benefit.title}
                                        </h3>
                                    </div>
                                </div>
                ...
                <FadeInSection delay={150}>
                    <div className="relative w-full mx-auto mb-28 overflow-visible">
                                ...
                                <div className="group h-full rounded-2xl border border-gray-800 hover:border-gray-700 transition-all duration-500 hover:translate-y-[-4px] backdrop-blur-sm bg-black/40 overflow-hidden">
                                    <div className="p-10 text-center">
                                        <div className="mb-8 inline-block">
                                            <div className="w-16 h-16 rounded-full bg-[#B3EBF2]/20 flex items-center justify-center mx-auto">
                                                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#B3EBF2]">
                                        ...
                                        <h3 className="text-3xl font-medium text-white group-hover:text-[#B3EBF2] transition-colors duration-300 mb-6">
                                            We Invest in People
                                        </h3>
                    ...
                    <div className="relative w-full mx-auto mb-28 overflow-visible">
                        <div className="flex justify-center relative">
                            <div style={{ 
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-0 rounded-2xl border border-gray-800 backdrop-blur-sm bg-black/40 overflow-hidden">
                                    <div className="flex flex-col px-8 py-6 h-full relative">
                                        <div>
                                            <svg className="w-10 h-10 text-[#B3EBF2] mb-4 opacity-60" fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
