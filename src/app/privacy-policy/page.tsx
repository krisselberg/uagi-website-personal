    ...
    <PageLayout>
      ...
      <section className="py-10 relative z-10">
        <div className="container max-w-5xl mx-auto">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Analytics data</strong> we receive from analytics providers such as Google Analytics which we use to improve our website, communications and the Services.</li>
            <li><strong>Information we receive from career websites</strong>, such as LinkedIn, Monster, or Indeed, which we use to process your application for employment.</li>
            <li><strong>Information we receive when you choose to link any social media platforms to your account or login to your account using any third party platforms</strong>, such as Google, which we use to maintain your account and login information.</li>
          </ul>
