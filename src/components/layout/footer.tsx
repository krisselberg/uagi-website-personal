      ...
      <div className="container max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-2 mb-8 md:mb-6">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex space-x-3 md:space-x-4">
              <a href="#" className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gray-800/50 flex items-center justify-center text-gray-400 hover:bg-[#B3EBF2]/20 hover:text-white transition-all duration-300">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex flex-wrap justify-center md:justify-end space-x-4 md:space-x-6">
            <Link href="#" className="text-gray-500 hover:text-[#B3EBF2] text-xs md:text-sm transition-colors duration-300">
              Privacy Policy
            </Link>
            <Link href="#" className="text-gray-500 hover:text-[#B3EBF2] text-xs md:text-sm transition-colors duration-300">
              Terms of Service
